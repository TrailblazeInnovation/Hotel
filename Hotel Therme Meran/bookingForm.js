export const FormExtension = {
    ...
    render: ({ trace, element }) => {
        ...
        const suitesData = [
            { id: 'suite_01', name: 'Vita Suite', imageSrc: 'https://www.hoteltermemerano.it/img/sales-content/3d92a810-b199-4492-b49b-09f406eafb58/426/426/crop/wisthaler.com%2D24%2D02%2Dhtm%2Dhw96182%2Dweb.JPG', description1: accommodationSize60, description2: accommodationPeople1_4, description3: 'Terrazza con vista giardino' },
            { id: 'suite_02', name: 'Suite', imageSrc: 'https://www.hoteltermemerano.it/img/sales-content/c9c5a713-8d8e-4f21-b7d9-110c82164c9f/426/426/crop/3205%2D316460.webp', description1: accommodationSize60, description2: accommodationPeople1_4, description3: 'Balcone privato arredato' },
            { id: 'suite_03', name: 'Calla Suite', imageSrc: 'https://www.hoteltermemerano.it/img/sales-content/8bc77ab5-3167-4783-a8ed-7d42b453bebc/426/426/crop/3205%2D316408.webp', description1: accommodationSize72, description2: accommodationPeople1_4, description3: 'Area soggiorno separata' },
        ];

        const roomsData = [
            { id: 'room_01', name: 'Acqua', imageSrc: 'https://www.hoteltermemerano.it/img/sales-content/fd938c17-b58e-46b2-b3d5-f744a5e3a439/426/426/crop/wisthaler.com%2D24%2D03%2Dfisi%2Dhtm%2Dhw98706%2D2.webp', description1: accommodationSize30, description2: accommodationPeople1_3, description3: 'Design moderno e luminoso' },
            { id: 'room_02', name: 'MeranO', imageSrc: 'https://www.hoteltermemerano.it/img/sales-content/49655acb-a119-45d2-9f80-44cacf9c817b/426/426/crop/wisthaler.com%2D24%2D03%2Dfisi%2Dhtm%2Dhw90489.webp', description1: accommodationSize30, description2: accommodationPeople1_3, description3: 'Vista sulla città di Merano' },
            { id: 'room_03', name: 'Loggia', imageSrc: 'https://www.hoteltermemerano.it/img/sales-content/55e9bc7c-3df8-4236-bb6f-f247d1db00a1/426/426/crop/01.JPG', description1: accommodationSize30, description2: accommodationPeople1_3, description3: 'Loggia privata con sedute' },
            { id: 'room_04', name: 'Cedro', imageSrc: 'https://www.hoteltermemerano.it/img/sales-content/d6ecc731-5ed8-4775-8754-f145467aecf7/426/426/crop/wisthaler.com%2D24%2D02%2Dhtm%2Dhw96272%2Dweb.JPG', description1: accommodationSize28, description2: accommodationPeople1_2, description3: 'Atmosfera accogliente e calda' },
            { id: 'room_05', name: 'Doppelzimmer Superior', imageSrc: 'https://www.hoteltermemerano.it/img/sales-content/58857828-7f98-4af5-aa9a-c5c1ecc0b270/426/426/crop/3205%2D262053.webp', description1: accommodationSize30, description2: accommodationPeople1_3, description3: 'Comfort elevato e spazio' },
            { id: 'room_06', name: 'Doppelzimmer Standard', imageSrc: 'https://www.hoteltermemerano.it/img/sales-content/8d53c197-52f2-4aca-b8bb-b071edc8b22f/426/426/crop/3205%2D347281.webp', description1: accommodationSize30, description2: accommodationPeople1_3, description3: 'Soluzione classica e funzionale' },
            { id: 'room_07', name: 'Doppelzimmer Standard Junior', imageSrc: 'https://www.hoteltermemerano.it/img/sales-content/2331341d-bcd2-4e2b-acb7-9e44eda7da22/426/426/crop/3205%2D262051.webp', description1: accommodationSize28, description2: accommodationPeople1_2, description3: 'Perfetta per viaggiatori singoli' },
        ];
